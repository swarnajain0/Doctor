...
import img13 from "../assets/galleryyy/images/img13.png";
import img14 from "../assets/galleryyy/images/img14.jpg";
import img15 from "../assets/galleryyy/images/img15.png";
...
import img23 from "../assets/galleryyy/images/img23.jpg";
import img24 from "../assets/galleryyy/images/img24.jpg";
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
              {block.images.map((img, index) => (
                <img
                  ...
                  className="rounded-lg shadow-md w-full h-[400px] object-contain object-center bg-white"
